/**
 * @file asrpro_codec.h
 * @brief asrpro inner codec驱动的头文件
 * @version 0.1
 * @date 2019-05-10
 * 
 ...
 * @defgroup asrpro_codec asrpro_codec
 * @brief asrpro芯片inner CODEC驱动
 * @{
 */
...
typedef struct 
{
    ...
    //!使用asrpro的ALC控制inner CODEC还是使用其本身的ALC控制
    inner_cedoc_gate_t use_asrpro_alc;
    //!ALC开关
