 ...
 * @brief IISDMA接收数据使能
 *
 * @param IISDMAx asrpro：IISDMA0和IISDMA1可选
 * @param cmd 使能或者禁止
 */
 ...
 *
 * @param IISDMAx asrpro：IISDMA0和IISDMA1可选
 * @param iisx asrpro：IISCha0、IISCha1、IISCha2可选
 ...
 * @brief IISDMA使能控制
 *
 * @param IISDMAx IISDMAx asrpro：IISDMA0和IISDMA1可选
 * @param cmd 使能或者禁止
 */
 ...
 * @brief IIS直通模式配置
 *
 * @param iis asrpro：IIS1、IIS2、IIS3可选
