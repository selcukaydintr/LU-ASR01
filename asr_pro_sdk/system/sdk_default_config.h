...
#define SDK_SUBVERSION                 6
#define SDK_REVISION                   8
#define SDK_TYPE                       "Offline"

/******************************** 开发板选择 **********************************/
//板级支持配置
#ifndef BOARD_PORT_FILE
#define BOARD_PORT_FILE                "asrpro_plus.c"
#endif
...
#define USE_EXTERNAL_CRYSTAL_OSC             0  //是否使用外部晶振。0：不使用外部晶振时钟；1：使用外部晶振时钟；默认使用外部晶振。
#endif
