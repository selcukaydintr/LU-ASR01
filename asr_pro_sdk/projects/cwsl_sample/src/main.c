...
// #include "asrpro_audio_capture.h"
#include "board.h"
#include "asrpro_uart.h"
#include "flash_manage_outside_port.h"
#include "system_msg_deal.h"
#include "asrpro_dpmu.h"
#include "asrpro_mailbox.h"
#include "asrpro_nuclear_com.h"
...
static void welcome(void)
{
    ci_loginfo(LOG_USER,"\r\n");
    ci_loginfo(LOG_USER,"\r\n");
    ci_loginfo(LOG_USER,"asrpro_sdk_%s_%d.%d.%d Built-in\r\n",
               SDK_TYPE,
               SDK_VERSION,SDK_SUBVERSION,SDK_REVISION);
    ci_loginfo(LOG_USER,"\033[1;32mWelcome to asrpro_SDK.\033[0;39m\r\n");
...
int main(void)
{
   ...
   // welcome();
    ...
    if (USE_EXTERNAL_CRYSTAL_OSC == 0)//PA0PA1引脚设置为IO
    {
            dpmu_osc_pad_for_gpio(ENABLE);
    }
           setup();
